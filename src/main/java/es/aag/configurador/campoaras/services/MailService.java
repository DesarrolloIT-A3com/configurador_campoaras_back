...
public class MailService 
{
	...
	public void sendMailAdminVerification(String username,String receiver,String usrToken,String seguridad,String verCode) throws CPException
	{
		String subject = "Verificacion de accion";
		String htmlContent = String.format(
				"<!DOCTYPE html>\n" +
				"<html>\n" +
				"<head>\n" +
				...
				"\n" +
				"<div class=\"instruction\">\n" +
				"Vas a realizar una accion de superadmistrador, introduce el siguiente código para continuar:\n" +
				"</div>\n" +
				"\n" +
				"<div class=\"code\">\n" +
				"%s\n" +
